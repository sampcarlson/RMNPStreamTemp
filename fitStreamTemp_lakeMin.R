...
#8 and 19 are very high - out of water
...
plot(tempData$Elevation,tempData$mean,xlab='',ylab='',pch=19,lwd.ticks=2,ylim=c(7,11))
...
plot(tempData$AboveLakeFrac,tempData$mean,xlab='',ylab='',pch=19,lwd.ticks=2,xlim=c(0.2,1),ylim=c(7,11))
...
plot(tempData$Uaa,tempData$mean,xlab='',ylab='',yaxt='n',xlim=c(0,83),pch=19,lwd.ticks=2,ylim=c(7,11))
...
plot(tempData$wtLakeElev,tempData$mean,xlab='',ylab='',yaxt='n',pch=19,lwd.ticks=2,ylim=c(7,11))
axis(side=2,at=c(7,8,9,10,11),labels=rep('',5),lwd.tick=2)
...
# 
# 
# display=data.frame(Al=literalSign(d$`I(wtLakeElev * AboveLakeFrac)`),
#                    bStar=literalSign(d$AboveLakeFrac),
#                    As=literalSign(d$`I(Elevation * (1 - AboveLakeFrac))`),
#                    Au=literalSign(d$`I(Uaa * (1 - AboveLakeFrac))`),
#                    AsPrime=literalSign(d$Elevation),
#                    AlPrime=literalSign(d$wtLakeElev),
